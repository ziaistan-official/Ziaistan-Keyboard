...
TRANSITIONS_MAP: dict[tuple[str, Placement], tuple[str, Placement | None]] = {
    ('q', Placement.SE): ('q', Placement.SW),
    ('q', Placement.NE): ('q', Placement.SE),

    ('w', Placement.NE): ('w', Placement.SE),

    ('e', Placement.SE): ('r', Placement.NW),
    ('e', Placement.NE): ('e', Placement.SE),

    ('r', Placement.NE): ('r', Placement.SE),
    ('t', Placement.NE): ('t', Placement.SE),
    ('y', Placement.NE): ('y', Placement.SE),
    ('u', Placement.NE): ('u', Placement.SE),
    ('i', Placement.NE): ('i', Placement.SE),

    ('o', Placement.SE): ('p', Placement.SW),
    ('o', Placement.NE): ('o', Placement.SE),

    ('p', Placement.NE): ('p', Placement.SE),

    ('a', Placement.NE): ('a', Placement.NW),
    ('a', Placement.NW): ('a', Placement.SW),

    ('s', Placement.NE): ('s', Placement.NW),

    ('g', Placement.SW): ('g', Placement.NW),
