...
public class KeyValueParserTest
{
  ...
  public void parse_old_syntax() throws Exception
  {
    ...
    Utils.parse(":str flags=',,':'Foo'", KeyValue.makeStringKey("Foo"));
    Utils.expect_error(":unknown:Foo");
    Utils.expect_error(":str:Foo");
    Utils.expect_error(":str flags:'Foo'");
    Utils.expect_error(":str flags=dim:'Foo'");
    Utils.expect_error(":str unknown='foo':'Foo'");
